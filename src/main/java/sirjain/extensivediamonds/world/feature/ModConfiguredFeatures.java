...
public class ModConfiguredFeatures {
    ...
    public static final RegistryEntry<ConfiguredFeature<OreFeatureConfig, ?>> RED_DIAMOND_ORE =
            ConfiguredFeatures.register("red_diamond_ore", Feature.ORE, new OreFeatureConfig(OVERWORLD_RED_DIAMOND_ORES, 2));

    public static final RegistryEntry<ConfiguredFeature<OreFeatureConfig, ?>> GREEN_DIAMOND_ORE =
            ConfiguredFeatures.register("green_diamond_ore", Feature.ORE, new OreFeatureConfig(OVERWORLD_GREEN_DIAMOND_ORES, 2));
